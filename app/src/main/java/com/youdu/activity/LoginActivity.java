...
import com.youdu.share.ShareManager.PlatofrmType;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    //发送登陆请求
    private void login() {
        String userName = mUserNameAssociateView.getText().toString().trim();//去掉用户名的空格
        String password = mPasswordView.getText().toString().trim();//去掉用户名的空格
